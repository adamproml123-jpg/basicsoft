...
Start-Process $winrarPath -ArgumentList "/S" -Wait
...
Start-Process $VLCPath -ArgumentList "/L=1033 /S" -Wait
...
Show-Done "Office 2013 Installed"
...
Start-Process $cpp -ArgumentList "/quiet /norestart" -Wait
Start-Process $ec -ArgumentList "/S" -Wait
...
# =========================
Write-Host "===============================================" -ForegroundColor Cyan
Write-Host "        ALL TASKS COMPLETED (INSTALLED)        " -ForegroundColor Cyan
Write-Host "===============================================" -ForegroundColor Cyan
pause
